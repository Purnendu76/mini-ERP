        ...
        <div className="px-6 py-3 border-b flex items-center justify-between bg-white/80 dark:bg-card/80 backdrop-blur-md sticky top-0 z-10 shadow-sm border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <h1 className="font-bold text-gray-800 dark:text-gray-100 tracking-tight">{pageLabel}</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <ThemeToggle />
            <button className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full text-slate-500 dark:text-slate-400 transition-colors">
