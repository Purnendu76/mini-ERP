    ...
    <Sidebar>
      <SidebarHeader>
        <div className="flex items-center gap-2 px-4 py-4">
          ...
          <span className="font-semibold tracking-tight">Management</span>
        </div>
      </SidebarHeader>
      <SidebarContent>
      ...
      <SidebarFooter className="p-4 border-t border-sidebar-border/50">
        <div className="relative group">
          ...
          <div className="absolute bottom-full left-0 w-full mb-2 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 ease-out z-50">
            <div className="bg-white border rounded-lg p-2 shadow-xl ring-1 ring-black/5 space-y-1">
              <div className="px-2 py-1.5 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                Application
              </div>
              <button className="w-full flex items-center gap-3 px-2 py-1.5 text-sm hover:bg-slate-50 rounded-md transition-colors group/item text-slate-700">
                <Settings size={16} className="text-slate-400 group-hover/item:text-slate-600" />
                <span className="font-medium">Settings</span>
              </button>
              <button className="w-full flex items-center gap-3 px-2 py-1.5 text-sm text-red-500 hover:bg-red-50 rounded-md transition-colors group/item">
          ...
          <div className="flex items-center gap-3 px-1 py-2 cursor-pointer rounded-lg hover:bg-slate-50 transition-colors">
            ...
            <div className="flex flex-col overflow-hidden">
              <span className="text-sm font-bold leading-tight truncate text-slate-900">System Admin</span>
              <div className="flex gap-1 mt-1">
                <span className="px-1.5 py-0.5 rounded text-[8px] font-black bg-blue-100 text-blue-700 uppercase tracking-tighter">Admin</span>
                <span className="px-1.5 py-0.5 rounded text-[8px] font-black bg-purple-100 text-purple-700 uppercase tracking-tighter">All Projects</span>
              </div>
            </div>
          </div>
        </div>
